...
class EmployeeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListAllEmployees = channel.unary_unary(
                ...
                _registered_method=True)
        self.UpdateEmployeeName = channel.unary_unary(
                '/employee_service.EmployeeService/UpdateEmployeeName',
                request_serializer=EmployeeService__pb2.EmployeeNameUpdate.SerializeToString,
                response_deserializer=EmployeeService__pb2.StatusReply.FromString,
                _registered_method=True)
        self.UpdateEmployee = channel.unary_unary(
                '/employee_service.EmployeeService/UpdateEmployee',
                request_serializer=EmployeeService__pb2.EmployeeData.SerializeToString,
                response_deserializer=EmployeeService__pb2.StatusReply.FromString,
                _registered_method=True)
...
class EmployeeServiceServicer(object):
    ...
    def UpdateEmployee(self, request, context):
        """Update an employee´s complete data (name and title)
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_EmployeeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateEmployeeName': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateEmployeeName,
                    request_deserializer=EmployeeService__pb2.EmployeeNameUpdate.FromString,
                    response_serializer=EmployeeService__pb2.StatusReply.SerializeToString,
            ),
...
class EmployeeService(object):
    ...
    @staticmethod
    def UpdateEmployeeName(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/employee_service.EmployeeService/UpdateEmployeeName',
            EmployeeService__pb2.EmployeeNameUpdate.SerializeToString,
            EmployeeService__pb2.StatusReply.FromString,
            options,
            channel_credentials,
            insecure,
